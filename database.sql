CREATE TABLE "tutees" (
	...
	"subject_1" integer(255) NOT NULL,
	"subject_2" integer(255) NOT NULL,
	"subject_3" integer(255) NOT NULL,
...
CREATE TABLE "tutors" (
	...
	"grade_level" varchar(255) NOT NULL,
	"school" varchar(255) NOT NULL,
	"mentoring_grade_id" integer(255) NOT NULL,
	"subjects_id" integer NOT NULL,
	"reference_1" varchar(1000) NOT NULL,
	"reference_2" varchar(1000) NOT NULL,
	"misc_info" varchar(10000),
	"submission_timestamp" TIMESTAMP NOT NULL,
	"matched" BOOLEAN NOT NULL,
