    ...
    <div>
      ...
      <div>
        <input
          ...
          id="5th Grade"
          name="5th Grade"
          onChange={(event) => changeFithGrade()}
        />
      ...
      <div>
        <input
          ...
          id="12th Grade"
          name="12th Grade"
          onChange={(event) => changeTwelthGrade()}
        />
      ...
      <div>
        ...
        />
        <label for="Math: Algebra 1/Linear Algebra">
      ...
      <div>
        ...
        />
        <label for="Math: Precalculus/Trigonometry">
      ...
      <div>
        ...
        />
        <label for="Science: Biology/Life Sciences">
      ...
      <div>
        ...
        />
        <label for="AP Honors Computer Science">
      ...
      <div>
        ...
        />
        <label for="AP Honors English Literature and Composition">
      ...
      <div>
        ...
        />
        <label for="AP Honors English Language and Composition">
      ...
      <div>
        ...
        />
        <label for="AP Honors United States History">
      ...
      <div>
        ...
        />
        <label for="AP Honors Government and Politics">
