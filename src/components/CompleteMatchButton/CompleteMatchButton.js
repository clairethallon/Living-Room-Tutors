          ...
          <Tabs id="uncontrolled-tab-example" className="mb-3">
            <Tab eventKey="Pending-Tutees" title="Email to Tutor">
              ...
              <div>
                ...
                {props.tutor.tutor_last_name},<br></br>
                <br></br>
                Great News! You have been matched! We are honored to have you
                join the LRT family as an official Living Room Tutor.<br></br>
                <br></br>
                ...
                {selectedTutee.tutee_misc_info}.<br></br>
                <br></br>
                ...
                to discontinue service with your tutee.
                <br></br>
                <br></br>
                ...
                <br></br>
                {selectedTutee.tutee_firstname}'s email:{" "}
            ...
            selectedTutee.student_or_guardian == "Student" ? (
              <Tab eventKey="Email-To-Tutee" title="Email to Tutee">
                ...
                <div>
                  <b>To: {selectedTutee.email_student}</b>
                  <br></br>
                  <b>Cc: {props.tutor.tutor_email}</b>
                  <br></br>
                  <br></br>
                  Dear {selectedTutee.tutee_firstname}{" "}
                  {selectedTutee.tutee_lastname},<br></br>
                  <br></br>
                  ...
                  upon receiving this email, please contact us.
                  <br></br>
                  <br></br>
                  There will be an LRT guide document attached below. Please
              ...
              <Tab eventKey="Email-To-Guardian" title="Email to Adult of Tutee">
                ...
                <div>
                  ...
                  matched! After careful consideration of the application, we
                  ...
                  tailored just for you. Your personalized tutor,{" "}
                  {props.tutor.tutor_first_name}, is going to be a wonderful
                  resource for {selectedTutee.tutee_firstname}.<br></br>
                  <br></br>
                  Note: If your tutor does not reach out after 5 business days
